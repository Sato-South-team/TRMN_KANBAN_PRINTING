...
// Type: TRMN_KANBAN_PRINTING.Reports.CrystallReport.OperationLog
...
{
  public class OperationLog : ReportClass
  {
    public override string ResourceName
    {
      get => "OperationLog.rpt";
      set
      {
      }
    }
    ...
    {
      get => "TRMN_KANBAN_PRINTING.Reports.CrystallReport.OperationLog.rpt";
      set
      {
      }
    }
