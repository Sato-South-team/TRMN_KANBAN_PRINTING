...
// Type: TRMN_KANBAN_PRINTING.Reports.CrystallReport.CachedOrderCreationLog
...
namespace TRMN_KANBAN_PRINTING.Reports.CrystallReport
{
  ...
  public class CachedOrderCreationLog : Component, ICachedReport
  {
    [Browsable(false)]
    ...
    {
      OrderCreationLog report = new OrderCreationLog();
