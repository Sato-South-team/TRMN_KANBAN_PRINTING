...
// Type: TRMN_KANBAN_PRINTING.Reports.CrystallReport.CachedTRMNlabelDesign
...
namespace TRMN_KANBAN_PRINTING.Reports.CrystallReport
{
  ...
  public class CachedTRMNlabelDesign : Component, ICachedReport
  {
    [Browsable(false)]
    ...
    {
      TRMNlabelDesign report = new TRMNlabelDesign();
