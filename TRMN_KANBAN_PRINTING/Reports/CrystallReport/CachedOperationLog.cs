...
// Type: TRMN_KANBAN_PRINTING.Reports.CrystallReport.CachedOperationLog
...
namespace TRMN_KANBAN_PRINTING.Reports.CrystallReport
{
  ...
  public class CachedOperationLog : Component, ICachedReport
  {
    [Browsable(false)]
    ...
    {
      OperationLog report = new OperationLog();
