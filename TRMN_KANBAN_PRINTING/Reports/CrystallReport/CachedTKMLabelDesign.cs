...
// Type: TRMN_KANBAN_PRINTING.Reports.CrystallReport.CachedTKMLabelDesign
...
namespace TRMN_KANBAN_PRINTING.Reports.CrystallReport
{
  ...
  public class CachedTKMLabelDesign : Component, ICachedReport
  {
    [Browsable(false)]
    ...
    {
      TKMLabelDesign report = new TKMLabelDesign();
