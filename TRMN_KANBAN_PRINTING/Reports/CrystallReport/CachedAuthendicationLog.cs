...
// Type: TRMN_KANBAN_PRINTING.Reports.CrystallReport.CachedAuthendicationLog
...
namespace TRMN_KANBAN_PRINTING.Reports.CrystallReport
{
  ...
  public class CachedAuthendicationLog : Component, ICachedReport
  {
    [Browsable(false)]
    ...
    {
      AuthendicationLog report = new AuthendicationLog();
